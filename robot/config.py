...
HDG_ERR_HYSTERESIS_DEG = 2.0   # новая: узкий пояс вокруг deadzone

# Полярность коррекции (быстрый тумблер, если крутит «не туда»)
HDG_SIGN = 1  # поставь -1, если нужно инвертировать

# Ограничения и динамика микро-импульсов
HDG_MIN_PULSE_MS = 25          # новая: минимальная длительность импульса
HDG_MAX_PULSE_MS = 160         # новая: мягче, чем прежние длительные импульсы
HDG_MIN_GAP_MS = 40          # новая: пауза между микро-импульсами

# --- Удержание курса ---
HDG_CORR_SPEED = 100   # базовая скорость корректирующих импульсов (PWM)
...
# Динамика скорости поворота
HDG_CORR_BASE_SPEED = 100      # новая: базовая скорость коррекции (было 120)
HDG_CORR_KSPEED = 0.8      # новая: насколько скорость растёт с ошибкой

# Нормировка и анти-windup
HDG_MAX_U_ABS = 60.0           # новая: «большая» ошибка, к которой всё нормируем
HDG_I_CLAMP = 50.0           # новая: ограничение интеграла

# Сглаживание yaw (меньше шума IMU — меньше ложных коррекций)
HDG_YAW_LPF_ALPHA = 0.25       # 0..1; 0 — сильнее фильтрует
